...
public interface CaseDAO {
    ...
    @Insert("insert into wedding.case (name,imageUrl,description,tags,price,like,team,status,created,modified) values(#{name},#{imageUrl},#{description},#{tags},#{price},#{like},#{team},#{status},now(),now)")
